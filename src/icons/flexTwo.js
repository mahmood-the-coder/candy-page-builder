...
export function getFlexTwoIcon(size="15",color="var(--color)")
{
    return /*html*/`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-4.152 117.437 507.117 290.629" xmlns:bx="https://boxy-svg.com"
        ...
        <rect x="18.387" y="148.873" width="214.881" height="221.827"
            style="stroke:${color}; stroke-linecap: square; fill:${color};" />
        <rect x="262.727" y="150.059" width="214.881" height="221.827"
            style="stroke:${color}; stroke-linecap: square; fill:${color};" />
    </svg>
    `
}